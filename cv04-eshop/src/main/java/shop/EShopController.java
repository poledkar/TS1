...
public class EShopController {
    ...
    private final PurchasesArchive archive;
    ...
    public static void main(String[] args) throws NoItemInStorage {
        ...
        controller.storage.printListOfStoredItems();

        System.out.println();

        System.out.println("TEST RUN:   Fill and purchase a shopping cart");
        ShoppingCart newCart = controller.newCart();
        ...
        controller.archive.printItemPurchaseStatistics();
        controller.storage.printListOfStoredItems();
        ...
        ShoppingCart newEmptyCart = controller.newCart();
        controller.purchaseShoppingCart(newEmptyCart, "Jarmila Novakova", "Spojovaci 23, Praha 3");
    }
}
